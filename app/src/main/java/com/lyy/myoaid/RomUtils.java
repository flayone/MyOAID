...
public final class RomUtils {
    ...
    //  全面屏适配指南  http://open.lenovo.com/developer/adp/helpData/database_detail.jsp?url=http://open.lenovo.com/sdk/?p=1484
    private static final String LENOVO = "lenovo";
    private static final String XIAPU = "sharp";
    ...
    public static boolean isHuawei() {
        return HUAWEI.equals(getRomInfo().name) || HONOR.equals(getRomInfo().name);
    }
    ...
    public static boolean isMeiZu() {
        return MEIZU.equals(getRomInfo().name);
    }
    ...
    public static boolean isXiaPu() {
        return XIAPU.equals(getRomInfo().name);
    }
    ...
    public static boolean isLenovo() {
        return LENOVO.equals(getRomInfo().name);
    }
    ...
    public static boolean isNokia() {
        return NOKIA.equals(getRomInfo().name);
    }
    ...
    public static boolean isNubia() {
        return NUBIA.equals(getRomInfo().name);
    }

    /**
     * @return 是否 google pixel 手机
     */
    public static boolean isGoogle() {
        return GOOGLE.equals(getRomInfo().name);
    }
