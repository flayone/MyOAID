...
public class OAIDHelper implements IIdentifierListener {
    ...
    public OAIDHelper(OaidUpdater oaidUpdater) {
...
//        int nres=DirectCall(cxt);
            ...
            ADLog.d(TAG + "return value: " + nres + " meaning：" + resultMeaning);
        } catch (Throwable e) {
            e.printStackTrace();
            ADLog.w(TAG + "getDeviceIds error");
        }
...
//        builder.append("UDID: ").append(udid).append("\n");
            ...
            ADLog.d(TAG + "ids_text == " + idstext);
            //将oaid 赋值给mercury sdk
            if (oaid != null && !"".equals(oaid)) {
                ADLog.d(TAG + "oaid == " + oaid);
                if (oaidUpdater != null) {
